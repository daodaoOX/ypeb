...
<div class="query_all">
	<div class="path">
        ...
        <a href="<%=path %>/frontPage/shopping/queryByOneMenu.jsp" target="index"><span>食品&gt;</span></a>
        <span>酒类</span>
...
<!--筛选-->
    <div class="filter">
    	<span class="title">分类筛选:</span>
         <a href="<%=path %>/frontPage/shopping/queryByTwoMenu.jsp" target="index"><span class="name">红酒</span></a>
         <a href="<%=path %>/frontPage/shopping/queryByTwoMenu.jsp" target="index"><span class="name">葡萄酒</span></a>
         <a href="<%=path %>/frontPage/shopping/queryByTwoMenu.jsp" target="index"><span class="name">白酒</span></a>
...
<div class="floor">
	<div class="foot">
		<div class="img_box">
			<a href="<%=path %>/frontPage/shopping/detail.jsp" target="index">
				<img class="foot_img" src="img/index/foot_4.png">
			</a>
		</div>
	...
	<div class="foot">
		<div class="img_box">
			<a href="<%=path %>/frontPage/shopping/detail.jsp" target="index">
				<img class="foot_img" src="img/index/foot_7.png">
			</a>
		</div>
